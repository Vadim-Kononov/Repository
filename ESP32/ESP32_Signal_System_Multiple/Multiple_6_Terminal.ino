...
/*Парсинг входой строки на 4 элемента по "/"*/
...
else if (string_1.equalsIgnoreCase("OTA")) {ArduinoOTA.begin(); TimerStop(); Writeln ("> OTA On: " + String(ESP.getFreeSketchSpace()), terminal); flag_OTA_pass = true;}
...
{Writeln (">\n| Login/<SSID>/<Password> | Save |\n| Scan | WiFi | Reconnect |\n| Count | CountR | Now |\n| Write/<Номер>/<Тип>/<Описание> |\n| Read | Clear/<Номер> |\n| SIM/<Команда> | INA |\n| On | Off | Alarm On | Alarm Off |\n| Time | Mem |\n| OTA | Reset |\n| ? | Help |\n>", terminal);}
