...
{
mqttClient.publish("send0", 0, false, String("String1").c_str());
mqttClient.publish("send1", 0, false, String("String2").c_str());
mqttClient.publish("send2", 0, false, String("String3").c_str());
}
}
/**/
